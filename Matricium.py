...
def create_matrice():
    ...
    nl = int(input("Combien de lignes : "))
    nc = int(input("Combien de colonnes : "))
    M = []
    i = 0
    while i < nl:
...
while True:
    try:
        ...
        if g == "":
            ...
            print("""~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
     Programme créer par Said najim et Yahia El Janati comme un projet d'ingénierie numérique proposée par Professeur Nadia Dreif;
                  Centre des Classes Préparatoires Salmane Al Farissi, MPSI-2 promotion 2022 ;)
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~""")
        elif g == "16":
